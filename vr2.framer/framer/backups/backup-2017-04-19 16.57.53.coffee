...
nothing_trigger = new VRLayer
	elevation: -90
	heading: 360
	
# Create array from triggers
triggers = [window_trigger, screen_trigger, table_trigger, wall_trigger, flipchart_trigger, tv_trigger, postits_trigger, nothing_trigger]
...
nothing_tooltip = new VRLayer
	name: "nothing_tooltip"
	elevation: 0
	heading: 360

# Create arrays from tooltips
tooltips = [window_tooltip, screen_tooltip, table_tooltip, wall_tooltip, flipchart_tooltip, tv_tooltip, postits_tooltip, nothing_tooltip]
