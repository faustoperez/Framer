...
shapes = ['<svg width="96" height="91" viewBox="0 0 96 91"><polygon fill="#CCC" fill-rule="evenodd" points="48 75 18.611 90.451 24.224 57.725 .447 34.549 33.305 29.775 48 0 62.695 29.775 95.553 34.549 71.776 57.725 77.389 90.451"/></svg>']
...
# 	fill = particle.querySelector('fill')

# 	fill.setAttribute("fill", "#{color}")

# container.children[i+3].querySelector(".icon").style.fill = colors[0]
