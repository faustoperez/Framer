...
if page.scrollX >= page.width  # without this limitation Utils.modulate will override earlier calls
		...
		mail.width	= Utils.modulate(page.scrollX, [page.width*3, page.width*4], 
								[ios_loca_.page4.w, ios_loca_.page5.w], true)
		mail.height	= Utils.modulate(page.scrollX, [page.width*3, page.width*4], 
								[ios_loca_.page4.h, ios_loca_.page5.h], true)
		mail.x			= Utils.modulate(page.scrollX, [page.width*3, page.width*4], 
								[ios_loca_.page4.x, ios_loca_.page5.x], true)
		mail.y			= Utils.modulate(page.scrollX, [page.width*3, page.width*4], 
