...
ball.on "change:x", ->
	ballA.x = Utils.modulate @x, [0, Screen.width], [0, Screen.height * .25]
	ballB.x = Utils.modulate @x, [0, Screen.height], [0, Screen.height * .5]
	ballC.x = Utils.modulate @x, [0, Screen.height], [0, Screen.height * .75]