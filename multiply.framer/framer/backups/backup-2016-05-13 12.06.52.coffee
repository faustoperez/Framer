...
ball.on "change:x", ->
	ballA.x = Utils.modulate @x, [0, Screen.width], [0, Screen.width * .25]
	ballB.x = Utils.modulate @x, [0, Screen.width], [0, Screen.width * .5]
	ballC.x = Utils.modulate @x, [0, Screen.width], [0, Screen.width * .75]